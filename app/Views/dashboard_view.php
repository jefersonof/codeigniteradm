	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
											...
											<div class="card-body pt-2">
												...
												<div class="d-flex align-items-center mt-10">
													...
													<div class="d-flex flex-column flex-grow-1">
														...
														<span class="text-muted font-weight-bold">Due in 3 Days2</span>
													</div>
													<!--end::Text-->
													<!--begin::Dropdown-->
													<div class="dropdown dropdown-inline ml-2" data-toggle="tooltip" title="Quick actions" data-placement="left">
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
				<h3 class="font-weight-bold m-0">Perfil de Usuário
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						...
						<div class="navi mt-2">
							...
							<a href="<?php echo base_url('/Login/Logout/');?>" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sair</a>
						</div>
					</div>
				</div>
				<!--end::Header-->
