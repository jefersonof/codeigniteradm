				...
				<div class="panel-body">
                    ...
                    <div class="form-row">
						 ...
						 <div class="form-group col-md-6" style="border-right:Solid 1px #D3D3D3; border-bottom:Solid 1px #D3D3D3; ">
                            ...
                            <div class="card" >
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="#" class="btn btn-primary" style="border:1px solid #000; color:red; background-color:#ebf2c4; margin:5px 0 0 20px">Baixe os modelos de relatório</a></br>
						...
						<div class="form-group col-md-6" style="border-right:Solid 1px #D3D3D3; border-bottom:Solid 1px #D3D3D3; ">
                            ...
                            <div class="card" >
                                <img class="card-img-top" src="../public/img/instrumentos/r-pas.png" alt="Card image cap" style="width:100px; height:120px">
                                <div class="card-body">
                                    <h5 class="card-title"><b>R-PAS</b></h5>
                                    <p class="card-text">O sistema baseia-se nas evidências do Teste Rorschach, ampliando sua utilidade, melhorando a base normativa e integrando novos estudos internacionais. Apresenta um sistema simplificado e uniforme de terminologia, símbolos, cálculos e apresentação de dados.</p>
                                    <a href="#" class="btn btn-primary" style="border:1px solid #000; color:red; background-color:#ebf2c4">Compre aqui!</a>
                                    <a href="#">
									<button type="button" data-toggle="modal" data-target="#tabelaPrecoModal" class="btn btn-warning" style="border:1px solid #000; color:red; background-color:#ebf2c4">
										Tabela de preços
									...
									<div class="modal-body">
										<div class="form-row">
											<div class="form-group col-md-12" style="background-color:#BEEFEB">
												<label for="inputEmail4">SRS-2</label>
											</div>
										</div><!-- form-row -->
