...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
			...
			<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				...
				<div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
					...
					<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
						...
						<!--end::Aside header-->
						<!--begin::Aside title-->
						<h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg" style="color: #986923;">Descubra o incrível Metronic 
						<br />com ótimas ferramentas de construção</h3>
						<!--end::Aside title-->
					</div>
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
						...
						<div class="login-form login-forgot">
							...
							<form class="form" novalidate="novalidate" id="kt_login_forgot_form">
								...
								<div class="form-group d-flex flex-wrap pb-lg-0">
									...
									<button type="button" id="kt_login_forgot_cancel" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3">Cancel222</button>
								</div>
								<!--end::Form group-->
							</form>
							<!--end::Form-->
		...
		<!--end::Main-->
		<script>var HOST_URL = "https://keenthemes.com/metronic/tools/preview2";</script>
