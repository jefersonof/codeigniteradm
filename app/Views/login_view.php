...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<script src="../../public/assets/plugins/global/plugins.bundle.js?v=7.0.5"></script>
		<script src="../../public/assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.0.5"></script>
		<script src="../../public/assets/js/scripts.bundle.js?v=7.0.5"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="../../public/assets/js/pages/custom/login/login-3.js?v=7.0.5"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>