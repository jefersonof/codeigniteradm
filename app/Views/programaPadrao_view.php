...
<body>
	...
	<nav class="navbar .navbar-default">
		<div class="container-fluid">
			...
			$user = session('testeLogin');//testeUser
			echo "<pre>";
				//var_dump($user[0]['nome']);//testeLogin
				var_dump($user);//testeLogin
			...
			<ul class="nav navbar-nav">
				<li>
					<a class="dropdown-toggle"  href="<?php echo base_url('/public/Sistema_Login/logout') ?>">Logout</a>
				</li>
			</ul>
